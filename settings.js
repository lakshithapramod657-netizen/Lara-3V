...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "3BIlmYCb#zYh0GuapEy7deX4rCLXYlawsn9-Lq4YAonmjJWFq5oc, // Add your session id
PREFIX: process.env.PREFIX || "🖤🥺",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94764674592",
DEV: process.env.DEV || "94764674592",
